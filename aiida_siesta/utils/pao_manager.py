...
class PaoManager:
    """
    Class to help modifications of PAO basis block.

    Also translates orbitals info
    ...
    def add_polarization(self, n, l):  # noqa
        ...
        try:
            ...
            raise ValueError(f"no orbital with n = {n} and l = {l} is present in the basis")
    ...
    def remove_orbital(self, n, l, Z):  # pylint: disable=too-many-statements
        """
        Add an orbital with n, l, Z quantum numbers.
    ...
    def pao_size(self):
        """
        Returns a string sumarazing the size of the basis in this class.
        ...
        dictpo = ["", "D", "T"]
        if self._pol_dict:
            string = f"{dictma[max_z - 1]}Z{dictpo[max_pz - 1]}P"
        else:
            string = f"{dictma[max_z - 1]}Z"
