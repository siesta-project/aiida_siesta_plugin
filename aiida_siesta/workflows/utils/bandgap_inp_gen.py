...
class BandgapWorkChainInputsGenerator(BaseWorkChainInputsGenerator):
    ...
    def get_inputs(self, structure, calc_engines, protocol, path_generator, relaxation_type=None):

        return super().get_inputs(structure, calc_engines, protocol, path_generator, relaxation_type)
