# -*- coding: utf-8 -*-
"""
Wrapper of a SiestaBaseWorkChain that give a suitable interface for aiida-optimize optimization.
"""
...
def validator_basis_opt(value, _):
    ...
    We shuould have at least one variable in the basis dict,
...
class ForBasisOptWorkChain(WorkChain):
    ...
    def should_run_wc(self):
        """
        Decides whether to run the SiestaBaseWorkChain.

        In fact, if the selected values for the
