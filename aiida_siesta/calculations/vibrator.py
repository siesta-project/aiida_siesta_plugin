...
class VibratorCalculation(JobCalculation):
    """
    Plugin for the Vibrator program in the Siesta-Vibra distribution, which
    computes the phonon spectrum from a Siesta calculation.
    """
    _siesta_plugin_version = 'aiida-0.11.0--plugin-0.11.5'

    def _init_internal_params(self):
        super(VibratorCalculation, self)._init_internal_params()

        # Default Siesta output parser provided by AiiDA
        #self._default_parser = "vibrator.parser"
