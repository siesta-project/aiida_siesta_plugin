...
copyright = u'2020, V.M. Garcia-Suarez, A. Garcia, E. Bosoni, V. Dikan, P. Febrer'
author = u'V.M. Garcia-Suarez, A. Garcia, E. Bosoni, V. Dikan, P. Febrer'
...
version = u'Dev-post-1.1.0'
# The full version, including alpha/beta/rc tags.
release = u'Dev-post-1.1.0'
...
latex_documents = [
    (master_doc, 'AiiDASiestaPlugin.tex', u'AiiDA Siesta Plugin Documentation',
     u'V.M. Garcia-Suarez, A. Garcia, E. Bosoni, V. Dikan, P. Febrer', 'manual'),
]
