...
def test_base(aiida_profile, fixture_sandbox, generate_calc_job, 
    ...
    retrieve_list = ['MESSAGES','time.json','aiida.fdf','aiida.out','aiida.xml','*.ion.xml']
...
def test_bandslines(aiida_profile, fixture_sandbox, generate_calc_job,
    ...
    retrieve_list = ['MESSAGES','time.json','aiida.fdf','aiida.out','aiida.xml','aiida.bands','*.ion.xml']
