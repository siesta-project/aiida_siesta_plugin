...
def test_base(aiida_profile, fixture_sandbox, generate_calc_job, 
    ...
    retrieve_list = ["w",'BASIS_ENTHALPY', 'MESSAGES','time.json','aiida.out','aiida.xml','*.ion.xml','aiida.EIG','aiida.KP']
...
def test_bandslines(aiida_profile, fixture_sandbox, generate_calc_job,
    ...
    retrieve_list = ['BASIS_ENTHALPY', 'MESSAGES','time.json','aiida.out','aiida.xml','aiida.bands','*.ion.xml','aiida.EIG','aiida.KP']
...
def test_lua(aiida_profile, fixture_sandbox, generate_calc_job, 
    ...
    retrieve_list = ['BASIS_ENTHALPY','aiida.EIG','aiida.KP','MESSAGES','time.json','aiida.out','aiida.xml','*.ion.xml','NEB.results']
